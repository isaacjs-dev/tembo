...
Route::middleware(['auth', 'workspace_context', 'active_account', 'verified_account', 'password_changed'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('role:global_admin')->group(function () {
        ...
        Route::post('public-catalog/reward-rules', [PublicCatalogRewardRuleController::class, 'store'])->name('public-catalog.reward-rules.store');
        Route::post('public-catalog/reward-rules/{rewardRule}/activate', [PublicCatalogRewardRuleController::class, 'activate'])->name('public-catalog.reward-rules.activate');
        Route::post('public-catalog/reward-rules/{rewardRule}/retire', [PublicCatalogRewardRuleController::class, 'retire'])->name('public-catalog.reward-rules.retire');
