<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div>
                <nav class="flex items-center gap-2 text-sm font-bold text-gray-400 mb-2">
                    ...
                    <span aria-hidden="true" class="material-symbols-outlined text-[16px]">chevron_right</span>
                    <span class="text-primary">Adicionar Aluno</span>
                </nav>
                <h1 class="text-4xl font-extrabold text-duo-heading dark:text-white tracking-tight">Adicionar Aluno</h1>
            </div>
    ...
    <div class="max-w-3xl" x-data="studentForm()">
        ...
        <div class="bg-white rounded-2xl border-2 border-duo-border p-8 mb-6">
            ...
            <p class="text-sm text-gray-400 mb-4">Digite o e-mail ou código de vínculo (8 caracteres) para verificar se
                o aluno já existe no sistema.</p>
            ...
            <div class="flex gap-3">
                <div class="relative group flex-1">
                    ...
                    <label for="student-search" class="sr-only">Buscar aluno por e-mail ou código de vínculo</label>
                    <input id="student-search" type="search" x-model="searchQuery" @keydown.enter.prevent="search()"
        ...
        <div x-show="showCreateForm" x-transition class="bg-white rounded-2xl border-2 border-duo-border p-8 mb-12">
            ...
            <form action="{{ route('institution.students.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    <label for="registration_number" class="text-gray-800 font-bold text-sm">Matrícula
                        (Opcional)</label>
            ...
            function studentForm() {
                return {
                    ...
                    async search() {
                        ...
                        try {
                            const response = await fetch('{{ route("institution.students.search") }}', {
                                method: 'POST',
                                headers: {
