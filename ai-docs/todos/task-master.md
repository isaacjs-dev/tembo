...
| PED-002 | Entrega e execução de aulas/atividades pelo aluno | PED-02 | PED-001 | done | Publicação, progresso, conclusão, tentativas e relatórios persistentes |
...
| PLAN-003 | Recompensas configuráveis e idempotentes | PLAN-04 | LIB-003, PLAN-002 | done | Aprovação gera um único crédito com caps |
| APP-001 | Modelo e versões de layout/cabeçalho/cartão | APP-01..03, APP-08 | ASM-001 | done | Versões imutáveis, defaults previsíveis, snapshots v2 e legado explícito |
...
| QR-002 | Regressão raster e homologação física QR | QR-04, APP-09 | QR-001, CARD-002 | done | 40/40 raster; perfil 30 mm/quiet zone 4; homologação em hardware registrada como pendência humana |
| OMR-001 | Dataset anotado e baseline reproduzível | OMR-01..06, §9 | CARD-002, QR-002 | done | Tuning/holdout isolados; baseline sintético congelado; físico registrado como pendência humana |
| OMR-002 | Pipeline real de câmera, geometria e confiança | OMR-02..04, OMR-10, OMR-11 | OMR-001, OMR-P0-003 | done | Sem métricas simuladas/ajustes normais; ambiguidades revisadas |
